  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 shadow-xl w-full max-w-lg text-center">
        ...
        {qr ? (
          <img src={qr} alt="QR Code" className="mx-auto mb-6" style={{ width: '480px', height: '480px', maxWidth: '100%', objectFit: 'contain' }} />
        ) : (
          <div className="text-gray-500 mb-6">QR tidak tersedia</div>
        )}
        <button onClick={onClose} className="bg-gray-800 text-white py-2 px-4 rounded-lg hover:bg-gray-900 transition">
          Tutup
        </button>
      </div>
    </div>
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold mb-2">Start WhatsApp Session</h3>
